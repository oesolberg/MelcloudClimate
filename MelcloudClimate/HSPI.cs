...
namespace HSPI_MelcloudClimate
{
    ...
    public class HSPI : HspiBase
    {
        ...
        private void CreateVerticalVane(Device connectedRootDevice, dynamic device, string deviceId)
        {
        ...
        private bool SetOperationMode(int deviceId, int operationMode)
        {
            ...
            {
                _log.Debug("For air to water (Zone1)");
                JsonCommand[deviceId.ToString()].OperationModeZone1 = operationMode;
            }
            else
            {
                _log.Debug("For air to air");
        ...
        private bool SetTemperature(int deviceId, int target)
        {
            ...
            {
                _log.Debug("For air to water (Zone1)");
                JsonCommand[deviceId.ToString()].SetTemperatureZone1 = target;
            }
            else
            {
                _log.Debug("For air to air");
